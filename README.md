...
### Goal
Help prepare a Ganesh Chaturthi celebration in one festive home/pandal. Collect modaks and festival items, solve short puzzles, and use hiding and distractions while Maa Parvati tends to the preparations. If Ganesha is caught by Maa Parvati, the run ends immediately with GAME OVER. Nobody is harmed.
...
### How to win
Collect any 5 of 6 modaks, 3 flowers, 3 durva, 2 diyas, 3 decorations, and complete the rangoli. The golden modak comes from the Festival Box; Mushak can retrieve the optional secret modak. The eight-minute festival clock becomes free play when it expires. Replay for under 5:00, a successful no-catch stealth run, or the secret.
